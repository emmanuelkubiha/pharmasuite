...
/**
 * ============================================================================
 * PAGE DE BIENVENUE / TRANSITION VERS LE SYSTÈME
 * ============================================================================
 * 
 * Importance : Page de transition après la vitrine (index.php)
 * 
 * Fonctionnement :
 * 1. Affiche un écran de chargement élégant (loader)
...
try {
    ...
    if ($config) {
        $nom_boutique = $config['nom_boutique'] ?? 'PHARMASUITE';
...
// ============================================================================
// DÉTERMINER LA PAGE DE DESTINATION (accueil ou login)
// ============================================================================
...
?>
<!-- Page de bienvenue/transition, ancien index.php -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
